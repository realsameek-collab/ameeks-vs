                ...
                <AnimatePresence>
                    {hovered && (
                        <motion.div
                            ...
                            className="pointer-events-none absolute left-11 top-1/2 z-50 -translate-y-1/2 whitespace-nowrap 
                            rounded-md border border-white/[0.08] bg-[#17171a] px-2 py-1 text-[11px] font-medium text-zinc-300 
...
function ActivityBar({showChat, showExplorer, showTerminal, setShowChat, setShowExplorer, setShowTerminal}) {
    

    return (
        <div className='flex w-14 shrink-0 flex-col items-center gap-2 border-r border-white/[0.06] bg-[#11111390] py-3'>
            <ActivityIcon
                icon={Files}
                label={"Explorer"}
                active={showExplorer}
