                 ...
                 dark:[&::-webkit-scrollbar-thumb]:bg-white/10 dark:hover:[&::-webkit-scrollbar-thumb]:bg-white/20'
                    >
                        ...
                        <div className='mb-8 flex items-start justify-between gap-3'>
                            <div>
                                <h1 className='flex items-center gap-2 text-[22px] font-semibold text-slate-900 dark:text-white'>
                            ...
                            <button
                                className='flex shrink-0 items-center gap-1.5 rounded-lg bg-slate-900 px-4 py-2.5 text-[13.5px]  
                        ...
                        {loading ? (
                            ...
                            <div className='mb-8 flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 
                             bg-white/40 py-16 text-center dark:border-white/[0.1] dark:bg-white/[0.01]'>
                                ...
                                <p className='mb-5 max-w-xs text-[13px] text-slate-500 dark:text-slate-500'>
                                    {activeSession === "starred"
                                        ? "Star your favorite projects and they'll appear here."
